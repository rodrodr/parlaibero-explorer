...
const VERSION = 'bef49936e79c7c79';
const CACHE = `diarios-explorer-${VERSION}`;
const PRECARGA = ["./", "./index.html", "./app.css?v=bef49936e79c7c79", "./app.js?v=bef49936e79c7c79", "./worker.js?v=bef49936e79c7c79", "./sqlite3.wasm?v=bef49936e79c7c79"];
