...
const VERSION = '4d1e36e8529907c2';
const CACHE = `diarios-explorer-${VERSION}`;
const PRECARGA = ["./", "./index.html", "./app.css?v=4d1e36e8529907c2", "./app.js?v=4d1e36e8529907c2", "./worker.js?v=4d1e36e8529907c2", "./sqlite3.wasm?v=4d1e36e8529907c2"];
