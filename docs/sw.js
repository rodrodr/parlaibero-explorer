...
const VERSION = '93250f93654d1f57';
const CACHE = `diarios-explorer-${VERSION}`;
const PRECARGA = ["./", "./index.html", "./app.css?v=93250f93654d1f57", "./app.js?v=93250f93654d1f57", "./worker.js?v=93250f93654d1f57", "./sqlite3.wasm?v=93250f93654d1f57"];
