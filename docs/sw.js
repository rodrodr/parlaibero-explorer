...
const VERSION = '5aa1ae1a04a915e5';
const CACHE = `diarios-explorer-${VERSION}`;
const PRECARGA = ["./", "./index.html", "./app.css?v=5aa1ae1a04a915e5", "./app.js?v=5aa1ae1a04a915e5", "./worker.js?v=5aa1ae1a04a915e5", "./sqlite3.wasm?v=5aa1ae1a04a915e5"];
